...
def get_params():
    ...
    parser.add_argument("--max_num_users", type=int, default=50000, help="Maximum number of users to crawl")
    parser.add_argument("--num_pages", type=int, default=10, help="Maximum number of pages to crawl")
